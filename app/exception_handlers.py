...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    # @app.exception_handler(NotCreatedTicket)
    # async def handle_not_created_ticket(request: Request, exc: UserNotFound):
    #     logger.error(f"Could not insert ticket")
    #     return JSONResponse(status_code=400, content="Could not insert ticket")
